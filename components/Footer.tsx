...
const SOCIALS = [
  { label: "GitHub", href: "https://github.com/kingsteck001", abbr: "GH" },
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/kingsley-mamah-830342263",
    abbr: "LI",
  },
  { label: "Twitter", href: "https://x.com/kings_techmedia", abbr: "TW" },
  { label: "Email", href: "mailto:mamahkingsleychuwebuka@gmail.com", abbr: "@" },
] as const;
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-16 pb-10 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="flex flex-col gap-5">
            <Link
              href="/"
              className="font-display text-2xl text-white hover:text-(--accent-warm) transition-colors"
            >
              kings<span className="text-(--accent-warm)">.</span>
            </Link>
            <p className="text-sm text-white/50 leading-relaxed max-w-xs">
              Full-stack developer building thoughtful products at the
              intersection of great engineering and great design.
            </p>
            <div className="flex items-center gap-2">
              <span
                className="block w-2 h-2 rounded-full bg-(--accent-warm) animate-pulse"
                aria-hidden="true"
              />
